/* File From chromium/src/tools/telemetry/telemetry/page/actions/scroll.js */
...
(function() {
  ...
  function ScrollGestureOptions(opt_options) {
    if (opt_options) {
      ...
      this.distance = opt_options.distance;
    } else {
  ...
  ScrollAction.prototype.startGesture_ = function() {
    ...
    var distance = this.options_.distance;
    ...
    chrome.gpuBenchmarking.smoothScrollBy(
        distance, this.onGestureComplete_.bind(this), 0, 0,
